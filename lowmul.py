...
from ntt10 import ntt10_ref, intt10_ref
from basemul import low_basemul_ref
...
def ilow_lay1_ref(in_ntt):
    ...
    out_poly += insert(f5[0], 5)

    return out_poly

def lowmul(in1_poly, in2_poly):
    in1_lay1 = low_lay1_ref(in1_poly)
    in2_lay1 = low_lay1_ref(in2_poly)
    out_lay1 = low_basemul_ref(in1_lay1, in2_lay1)
    out_low = ilow_lay1_ref(out_lay1)
    out_low += (in1_poly[80] * in2_poly[0] + in1_poly[0] * in2_poly[80]) * x ** 80
    return out_low
