...
def ntt5_qd_noh04(f0, f1, f2, f3, f4):
    red = w5 + w5 ** 4 - w5 ** 3 - w5 ** 2
    green = 2 * (w5 - w5 ** 4)
    blue = 2 * (w5 - w5 ** 4 + w5 ** 3 - w5 ** 2)
    yellow = 2 * (w5 ** 3 - w5 ** 2)
...
def ntt5_qd_noh014(f0, f1, f2, f3, f4):
    red = w5 + w5 ** 4 - w5 ** 3 - w5 ** 2
    green = 2 * (w5 - w5 ** 4)
    blue = 2 * (w5 - w5 ** 4 + w5 ** 3 - w5 ** 2)
    yellow = 2 * (w5 ** 3 - w5 ** 2)
...
def ntt5_qd_noh23(f0, f1, f2, f3, f4):
    red = w5 + w5 ** 4 - w5 ** 3 - w5 ** 2
    green = 2 * (w5 - w5 ** 4)
    blue = 2 * (w5 - w5 ** 4 + w5 ** 3 - w5 ** 2)
    yellow = 2 * (w5 ** 3 - w5 ** 2)
...
def ntt5_qd_noh023(f0, f1, f2, f3, f4):
    red = w5 + w5 ** 4 - w5 ** 3 - w5 ** 2
    green = 2 * (w5 - w5 ** 4)
    blue = 2 * (w5 - w5 ** 4 + w5 ** 3 - w5 ** 2)
    yellow = 2 * (w5 ** 3 - w5 ** 2)
...
def intt5_20x_nof04(h0, h1, h2, h3, h4):
    return ntt5_qd_noh04(h0, h4, h3, h2, h1)

def intt5_20x_nof23(h0, h1, h2, h3, h4):
    return ntt5_qd_noh23(h0, h4, h3, h2, h1)
